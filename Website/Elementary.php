...
<body>
    <main class="SubMateri">
        ...
        <div class="SubMateriBagian">
            <form action="VideoStudent.php" method="post">
                <input type="hidden" name="dariWebsite" value="Elementary">
    ...
    <main class="Elementary">
        <div class="ElementaryPerBagian Satu">
            <img src="../Bahan/Kelas_Elementary.png" class="ElementaryCoverBuku">
            <div class="ElementaryKontenSatu">
                <div class="ElementarySubKontenSatu" style="width: 100%;">
                    <?php
                        include 'Koneksi.php';
                        ...
                        $simpanAkunStudent = "";
                        while ($LihatAkunStudent = mysqli_fetch_array($eksekusicariIdStudent)) {
                            if ($LihatAkunStudent["nama_produk"] == 'Kelas Elementary' ) {
                                $simpanAkunStudent = $LihatAkunStudent["nama_produk"];
                            }
                        }

                        if ($simpanAkunStudent == 'Kelas Elementary' ) {
                            $Status = 'Anda Sudah Berlangganan';
                            $StatusTombol = "";
                        ?>
                            Elementary <p style="margin-left: 10px; font-size: 20px; width: 500px;"> &nbsp  <?php echo '(', $Status, ')' ; ?></p>
                        
                        <?php
                        }

                        
                        else if ($simpanAkunStudent != 'Kelas Elementary') {
                    ...
                    ?>
                            ...
                            <form action="PaymentProses.php" method="post" style="margin-left: 15%;" >
                                <input type="hidden" name='Beli' value="BeliElementary">
                ...
                <div class="ElementarySubKontenSatu" style="font-size: 25px;">
                    <img src="../Bahan/Tingkat_Mudah.png" width="40px">&nbsp;
                    Level - Dasar
                </div>
                <div class="ElementarySubKontenSatu" style="font-size: 25px; width: auto;">
        ...
        <div class="ElementaryPerBagian Dua" style="font-size: 35px;">
            Hal Yang Didapat
        </div>
        <div class="ElementaryPerBagian Tiga">
            <div class="ElementarySubKontenTiga">
            <?php 
                ...
                if ($SimpanStatusSertif != 0) { ?>
                    <a href="<?php echo $SimpanStatusSertif ;?>" download=""> <img src="../Bahan/Sertifikat.png" class="ElementarySubKontenSubTiga"> </a>
                <?php } if ($SimpanStatusSertif == 0) {?>
                    <img src="../Bahan/Sertifikat.png" class="ElementarySubKontenSubTiga"> <?php } ?>

                <div class="ElementarySubKontenSubTiga ElementarySubKontenSubTigaDeskripsi">
                    <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Sertifikat</div>
                    <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Dapatkan sertifikat setelah menyelsaikan kelas ini .</div>
                </div>
            </div>

            <?php  if ($simpanAkunStudent == 'Kelas Elementary') { ?>
                    
                    <form action="Kuis.php" method="post">
                        <input type="hidden" name="AsalWebsite" value="Elementary">  
                        <button type="submit" class="ElementarySubKontenTiga">
                            <img src="../Bahan/Kuis.png" class="ElementarySubKontenSubTiga">
                            <div class="ElementarySubKontenSubTiga ElementarySubKontenSubTigaDeskripsi">
                                <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Kuis</div>
                                <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                            </div>
                        </button>
                    </form>
                ...
                <?php if ($simpanAkunStudent != 'Kelas Elementary') {?>
                    ...
                    <div type="submit" class="ElementarySubKontenTiga">
                        <img src="../Bahan/Kuis.png" class="ElementarySubKontenSubTiga">
                        <div class="ElementarySubKontenSubTiga ElementarySubKontenSubTigaDeskripsi">
                            <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Kuis</div>
                            <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                ...
                <?php  if ($simpanAkunStudent == 'Kelas Elementary') { ?>
                    ...
                    <form class="ElementarySubKontenTiga" action="FinalExam.php" method="post" >
                        <input type="hidden" name="AsalWebsite" value="Elementary" >  
                        <button type="submit" class="ElementarySubKontenTiga" style="border: none;">
                            <img src="../Bahan/Kuis.png" class="ElementarySubKontenSubTiga">
                            <div class="ElementarySubKontenSubTiga ElementarySubKontenSubTigaDeskripsi">
                                <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Ujian</div>
                                <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                            </div>
                        </button>
                    </form>
                ...
                <?php  if ($simpanAkunStudent != 'Kelas Elementary') { ?>
                    ...
                    <div class="ElementarySubKontenTiga">
                        <img src="../Bahan/Ujian.png" class="ElementarySubKontenSubTiga">
                        <div class="ElementarySubKontenSubTiga ElementarySubKontenSubTigaDeskripsi">
                            <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Ujian</div>
                            <div class="ElementarySubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                        </div>
        ...
        <div class="ElementaryPerBagian Empat">
        ...
        <div class="ElementaryPerBagian Lima">
            <div class="ElementarySubBagianLima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri1">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        </div>
        <div class="ElementaryPerBagian Lima">
            <div class="ElementarySubBagianLima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri2">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri3">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri4">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri5">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri6">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri7">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri8">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri9">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="ElementaryPerBagian Lima">
            ...
            <div class="ElementarySubBagianLima ElementarySubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="ElementarySubBagianSubLima" id="TombolBukaSubMateri10">
                <div class="ElementarySubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="ElementarySubBagianSubLima">
                <div class="ElementarySubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
