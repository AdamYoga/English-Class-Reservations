...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Setting1.css">
...
<section class="order" id="order">
    ...
    <div class="flex-container">
        <div class="container">
            <h2 class="text1"><div class="ContainerFokus"></div><i class="fa-sharp fa-solid fa-user-gear"></i>  Akun</h2>
            <h2 class="text"><a href="Setting2.php"> <i class="fa-solid fa-file-lines"></i> </a>  Sertifikat</h2>
        </div>
        <div class="container1">
            <form class="form1" action="Setting1GantiAkun.php" method="post">
                <h2>Ubah Email</h2>
                <div class="inputBox">
                    <div class="input">
                ...
                <input type="submit" value="Ubah Email" class="button">
            </form>
        </div>
        <div class="container1">
            <form class="form2" action="Setting1GantiPassword.php" method="post">
                <div>
                    <h2>Ubah Password</h2>
                    <table class="judul">
                        <tr>
                            <td>Isi jika ingin mengubah password</td>
                        </tr>
                    </table>
                    <div class="inputBox">
                        <div class="input">
                            ...
                            <h4>Masukkan minimal 8 karakter dengan kombinasi huruf dan angka</h4>
                        </div>
                    </div>
                    ...
                    <div class="inputBox">
                        <div class="input">
                            ...
                            <input type="password" placeholder="Masukkan password baru" name="KonfirmasiPassword">
                        </div>
                    </div>
