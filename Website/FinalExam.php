...
<head>
    ...
    <link rel="stylesheet" href="FinalExam.css">
...
<body>
    ...
    <?php 
        ...
        if (!empty($_POST['AsalWebsite'])) {
            ...
            $bacaSoalKuisNo1 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 1 ";
            $bacaSoalKuisNo2 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 2 ";
            $bacaSoalKuisNo3 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 3 ";
            $bacaSoalKuisNo4 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 4 ";
            $bacaSoalKuisNo5 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 5 ";
            $bacaSoalKuisNo6 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 6 ";
            $bacaSoalKuisNo7 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 7 ";
            $bacaSoalKuisNo8 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 8 ";
            $bacaSoalKuisNo9 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 9 ";
            $bacaSoalKuisNo10 = " SELECT * FROM `soaljawab_exam` WHERE kuis_untuk = '$asalWebsite' AND no_soal = 10 ";
            ...
            $eksekusiBacaSoalKuisNo6 =  mysqli_query($apaya, $bacaSoalKuisNo6);
            $eksekusiBacaSoalKuisNo7 =  mysqli_query($apaya, $bacaSoalKuisNo7);
            $eksekusiBacaSoalKuisNo8 =  mysqli_query($apaya, $bacaSoalKuisNo8);
            $eksekusiBacaSoalKuisNo9 =  mysqli_query($apaya, $bacaSoalKuisNo9);
            $eksekusiBacaSoalKuisNo10 =  mysqli_query($apaya, $bacaSoalKuisNo10);
        
    ?>

    <main class="Kuis">
        <div class="KuisSubBagian" style="display: grid; text-align: center;">
            <i style="font-weight: 600; font-size: 35px; font-style: normal;">Final Exam</i>
        ...
        <div class="KuisSubBagian KuisSubBagianSoal">
            <form action="FinalExamProses.php" method="post" class="KuisSubBagianSubSoal">
                ...
                <?php while ($ListJawabdanSoal = mysqli_fetch_array($eksekusiBacaSoalKuisNo6)) { ?>

                <div class="KuisSubBagianSubSoal">
                    <div class="KuisSubBagianPertanyaan">6. &nbsp; <?php echo $ListJawabdanSoal["soal"]; ?></div>
                    <div class="KuisSubBagianJawaban">
                        <div>
                            <input type="radio" id="Jawaban6" name="Jawaban6" value="Jawaban Benar" required>
                            <label><?php echo $ListJawabdanSoal["jawab1"]; ?></label>
                        </div>
                    
                        <div>
                            <input type="radio" id="Jawaban6" name="Jawaban6" value="Jawaban Salah">
                            <label ><?php echo $ListJawabdanSoal["jawab2"]; ?></label>
                        </div>
                    </div>
                </div>
                ...
                <?php while ($ListJawabdanSoal = mysqli_fetch_array($eksekusiBacaSoalKuisNo7)) { ?>

                <div class="KuisSubBagianSubSoal">
                    <div class="KuisSubBagianPertanyaan">7. &nbsp; <?php echo $ListJawabdanSoal["soal"]; ?></div>
                    <div class="KuisSubBagianJawaban">
                        <div>
                            <input type="radio" id="Jawaban7" name="Jawaban7" value="Jawaban Benar" required>
                            <label><?php echo $ListJawabdanSoal["jawab1"]; ?></label>
                        </div>
                    
                        <div>
                            <input type="radio" id="Jawaban7" name="Jawaban7" value="Jawaban Salah">
                            <label ><?php echo $ListJawabdanSoal["jawab2"]; ?></label>
                        </div>
                    </div>
                </div>
                ...
                <?php while ($ListJawabdanSoal = mysqli_fetch_array($eksekusiBacaSoalKuisNo8)) { ?>

                <div class="KuisSubBagianSubSoal">
                    <div class="KuisSubBagianPertanyaan">8. &nbsp; <?php echo $ListJawabdanSoal["soal"]; ?></div>
                    <div class="KuisSubBagianJawaban">
                        <div>
                            <input type="radio" id="Jawaban8" name="Jawaban8" value="Jawaban Benar" required>
                            <label><?php echo $ListJawabdanSoal["jawab1"]; ?></label>
                        </div>
                    
                        <div>
                            <input type="radio" id="Jawaban8" name="Jawaban8" value="Jawaban Salah">
                            <label ><?php echo $ListJawabdanSoal["jawab2"]; ?></label>
                        </div>
                    </div>
                </div>
                ...
                <?php while ($ListJawabdanSoal = mysqli_fetch_array($eksekusiBacaSoalKuisNo9)) { ?>

                <div class="KuisSubBagianSubSoal">
                    <div class="KuisSubBagianPertanyaan">9. &nbsp; <?php echo $ListJawabdanSoal["soal"]; ?></div>
                    <div class="KuisSubBagianJawaban">
                        <div>
                            <input type="radio" id="Jawaban9" name="Jawaban9" value="Jawaban Benar" required>
                            <label><?php echo $ListJawabdanSoal["jawab1"]; ?></label>
                        </div>
                    
                        <div>
                            <input type="radio" id="Jawaban9" name="Jawaban9" value="Jawaban Salah">
                            <label ><?php echo $ListJawabdanSoal["jawab2"]; ?></label>
                        </div>
                    </div>
                </div>
                ...
                <?php while ($ListJawabdanSoal = mysqli_fetch_array($eksekusiBacaSoalKuisNo10)) { ?>

                <div class="KuisSubBagianSubSoal">
                    <div class="KuisSubBagianPertanyaan">10. &nbsp; <?php echo $ListJawabdanSoal["soal"]; ?></div>
                    <div class="KuisSubBagianJawaban">
                        <div>
                            <input type="radio" id="Jawaban10" name="Jawaban10" value="Jawaban Benar" required>
                            <label><?php echo $ListJawabdanSoal["jawab1"]; ?></label>
                        </div>
                    
                        <div>
                            <input type="radio" id="Jawaban10" name="Jawaban10" value="Jawaban Salah">
                            <label ><?php echo $ListJawabdanSoal["jawab2"]; ?></label>
                        </div>
                    </div>
                </div>
...
<script src="FinalExam.js"></script>
</html>