...
<body>
    <main class="SubMateri">
        ...
        <div class="SubMateriBagian">
            <form action="VideoStudent.php" method="post">
                <input type="hidden" name="dariWebsite" value="Intermediate">
    ...
    <main class="Intermediate">
        <div class="IntermediatePerBagian Satu">
            <img src="../Bahan/Kelas_Intermediate.png" class="IntermediateCoverBuku">
            <div class="IntermediateKontenSatu">
                <div class="IntermediateSubKontenSatu">
                    <?php
                        include 'Koneksi.php';
                        ...
                        $simpanAkunStudent = "";
                        while ($LihatAkunStudent = mysqli_fetch_array($eksekusicariIdStudent)) {
                            if ($LihatAkunStudent["nama_produk"] == 'Kelas Intermediate' ) {
                                $simpanAkunStudent = $LihatAkunStudent["nama_produk"];
                            }
                        }

                        if ($simpanAkunStudent == 'Kelas Intermediate' ) {
                            $Status = 'Anda Sudah Berlangganan';
                            $StatusTombol = "";
                        ?>
                            Intermediate <p style="margin-left: 10px; font-size: 20px; width: 500px;"> &nbsp  <?php echo '(', $Status, ')' ; ?></p>
                    ...
                    ?>
                                ...
                                <form action="PaymentProses.php" method="post" style="margin-left: 15%;" >
                                    <input type="hidden" name='Beli' value="BeliIntermediate">
                ...
                <div class="IntermediateSubKontenSatu" style="font-size: 25px;">
                    <img src="../Bahan/Tingkat_Sedang.png" width="40px">&nbsp;
                    Level - Sedang
                </div>
                <div class="IntermediateSubKontenSatu" style="font-size: 25px; width: auto;">
        ...
        <div class="IntermediatePerBagian Dua" style="font-size: 35px;">
            Hal Yang Didapat
        </div>
        <div class="IntermediatePerBagian Tiga">
            <div class="IntermediateSubKontenTiga">
            <?php 
                ...
                if ($SimpanStatusSertif != 0) { ?>
                    <a href="<?php echo $SimpanStatusSertif ;?>" download=""> <img src="../Bahan/Sertifikat.png" class="IntermediateSubKontenSubTiga"> </a>
                <?php } if ($SimpanStatusSertif == 0) {?>
                    <img src="../Bahan/Sertifikat.png" class="IntermediateSubKontenSubTiga"> <?php } ?>

                <div class="IntermediateSubKontenSubTiga IntermediateSubKontenSubTigaDeskripsi">
                    <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Sertifikat</div>
                    <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Dapatkan sertifikat setelah menyelsaikan kelas ini .</div>
                </div>
            </div>
            <?php  if ($simpanAkunStudent == 'Kelas Intermediate') { ?>
                    
                    <form action="Kuis.php" method="post">
                        <input type="hidden" name="AsalWebsite" value="Intermediate">  
                        <button type="submit" class="IntermediateSubKontenTiga">
                            <img src="../Bahan/Kuis.png" class="IntermediateSubKontenSubTiga">
                            <div class="IntermediateSubKontenSubTiga IntermediateSubKontenSubTigaDeskripsi">
                                <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Kuis</div>
                                <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                            </div>
                        </button>
                    </form>
            ...
            <?php if ($simpanAkunStudent != 'Kelas Intermediate') {?>
                    ...
                    <div type="submit" class="IntermediateSubKontenTiga">
                        <img src="../Bahan/Kuis.png" class="IntermediateSubKontenSubTiga">
                        <div class="IntermediateSubKontenSubTiga IntermediateSubKontenSubTigaDeskripsi">
                            <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Kuis</div>
                            <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                ...
                <?php  if ($simpanAkunStudent == 'Kelas Intermediate') { ?>
                    ...
                    <form class="IntermediateSubKontenTiga" action="FinalExam.php" method="post" >
                        <input type="hidden" name="AsalWebsite" value="Intermediate" >  
                        <button type="submit" class="IntermediateSubKontenTiga" style="border: none;">
                            <img src="../Bahan/Kuis.png" class="IntermediateSubKontenSubTiga">
                            <div class="IntermediateSubKontenSubTiga IntermediateSubKontenSubTigaDeskripsi">
                                <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Ujian</div>
                                <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                            </div>
                        </button>
                    </form>
                ...
                <?php  if ($simpanAkunStudent != 'Kelas Intermediate') { ?>
                    ...
                    <div class="IntermediateSubKontenTiga">
                        <img src="../Bahan/Ujian.png" class="IntermediateSubKontenSubTiga">
                        <div class="IntermediateSubKontenSubTiga IntermediateSubKontenSubTigaDeskripsi">
                            <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 600; font-size: 20px;">Ujian</div>
                            <div class="IntermediateSubKontenSubTigaSubDeskripsi" style="font-weight: 400; font-size: 17px;">Kuis pilihan ganda membantu memahami materi yang dipelajari.</div>
                        </div>
        ...
        <div class="IntermediatePerBagian Empat">
        ...
        <div class="IntermediatePerBagian Lima">
            <div class="IntermediateSubBagianLima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri1">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        </div>
        <div class="IntermediatePerBagian Lima">
            <div class="IntermediateSubBagianLima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri2">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri3">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri4">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri5">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri6">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri7">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri8">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri9">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
        ...
        <div class="IntermediatePerBagian Lima">
            ...
            <div class="IntermediateSubBagianLima IntermediateSubBagianLimaRataBawah">
                <img src="../Bahan/Materi.png" class="IntermediateSubBagianSubLima" id="TombolBukaSubMateri10">
                <div class="IntermediateSubBagianSubLima" style="width: 128px;">5 Sub Materi</div>
                <img src="../Bahan/Kuis_SubMateri.png" class="IntermediateSubBagianSubLima">
                <div class="IntermediateSubBagianSubLima" style="width: auto;">1 kuis Sub/Materi</div>
            </div>
